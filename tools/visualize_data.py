...
def parse_args(in_args=None):
    ...
    parser.add_argument(
        "--config-file", default="configs/COCO-detection/faster_rcnn_R_101_FPN_ft_fc_all_10shot.yaml", metavar="FILE", help="path to config file"
    )
    parser.add_argument(
        "--output-dir", default="./vis-output", help="path to output directory"
    )
    parser.add_argument(
